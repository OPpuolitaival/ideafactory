...
const fi: Record<TranslationKey, string> = {
  ...
  'method.1.name': 'Perusperiaatteet',
  'method.1.description': 'Pura toiminnoiksi, rakenna uudelleen rajoitteista',
  'method.1.goodFor': 'Oletusten uudelleenarviointi, radikaali yksinkertaistaminen',
  'method.2.name': 'Biomimetiikka',
  'method.2.description': 'Lainaa mekanismeja luonnosta',
  'method.2.goodFor': 'Rakenteellinen innovaatio, tehokkuus',
  'method.3.name': 'TRIZ',
  'method.3.description': 'Ristiriitojen ratkaisumallit insinööripatenteista',
  'method.3.goodFor': 'Kompromissien ratkaisu, tekniset ongelmat',
  'method.4.name': 'Inversio',
  'method.4.description': 'Käännä oletukset päälaelleen',
  'method.4.goodFor': 'Jumiutumisen murtaminen, yllättävät ratkaisut',
  'method.5.name': 'Äärirajoitteet',
  'method.5.description': 'Suunnittele mahdottomien rajojen puitteissa',
  'method.5.goodFor': 'Pakotettu luovuus, kustannusinnovaatio',
  'method.6.name': 'Käyttäjäarkkityyppien roolipeli',
  'method.6.description': 'Tiettyjen käyttäjien kontekstit',
  'method.6.goodFor': 'Empatialähtöinen suunnittelu, saavutettavuus',
  'method.7.name': 'Morfologinen analyysi',
  'method.7.description': 'Systemaattinen yhdistely ulottuvuuksien yli',
  'method.7.goodFor': 'Tyhjentävä tutkimus, kombinatorinen uutuus',
  'method.8.name': 'Materiaalilähtöinen tutkimus',
  'method.8.description': 'Aloita materiaalien ominaisuuksista',
  'method.8.goodFor': 'Kestävyys, valmistusinnovaatio',
  'method.9.name': 'Kulttuuriantropologia',
  'method.9.description': 'Rituaalit, normit, käytön symboliikka',
  'method.9.goodFor': 'Tunnesuunnittelu, kulttuurinen sopivuus',
  'method.10.name': 'Fysiikka-/pelisimulaatio',
  'method.10.description': 'Optimoi simulaation avulla',
  'method.10.goodFor': 'Suorituskyky, urheilu, interaktiiviset tuotteet',
